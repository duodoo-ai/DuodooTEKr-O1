...
class account_sale_invoice_delivery(models.Model):
    ...
    price_subtotal = fields.Float('开票金额', digits='Product Price', group_operator="sum")
    ...
    delivery_price = fields.Float(string='出货单价', digits=(16, 4), group_operator="avg")
    price_unit = fields.Float(string='开票单价', digits=(16, 4), group_operator="avg")
